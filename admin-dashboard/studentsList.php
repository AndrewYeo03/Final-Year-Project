...
// Fetch students list from database with pagination
$sql = "SELECT id, username, email, class_name, firstname, lastname FROM students LIMIT $limit OFFSET $offset";
$result = $conn->query($sql);

// Fetch total number of students for pagination
$total_sql = "SELECT COUNT(*) AS total FROM students";  // Adjusted to 'students' table
                                ...
                                <?php while ($row = $result->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- Delete Button -->
                                            <a href="deleteStudent.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this student?')">Delete</a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            <?php else: ?>
